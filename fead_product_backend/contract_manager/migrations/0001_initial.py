    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_zip_code', models.CharField(blank=True, max_length=20, verbose_name='Default ZIP Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.sellerprofile', verbose_name='Owner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth_app.sellerprofile', verbose_name='Seller')),
            ],
            options={
